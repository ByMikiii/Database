      ...
      <div class="navbar-collapse collapse" id="navbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="/pages/articles.php" id="navbarDarkDropdownMenuLink" role="button"
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <div class="login-data">
              <a href="/profile/?username=<?php echo $_SESSION["username"]?>"><img class='profile-picture'
                  src="<?php echo $_SESSION["avatar-path"]?>" alt="Profile Picture"></a>
